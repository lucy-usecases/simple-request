...
module.exports = JSON.parse("{\"id\":\"e1331fc4-4063-4a4e-c35b-ee440c42c86e\",\"author\":\"eutech\",\"widgets\":[{\"id\":\"simple-request\",\"title\":\"Simple Request\",\"description\":\"A UI to accept a simple request or complaint from a user\"}]}");
...
exports.RequestWidget = (props) => {
    ...
    function submit() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                if (!subject)
                    throw 'Please specify a subject';
                if (!description)
                    throw 'Please specify a description';
                let r = yield props.uxpContext.executeAction(model, action, { subject, description }, { json: true });
    ...
    function renderModal() {
        return React.createElement(components_1.Modal, { className: 'simple-request', title: 'Register Request', show: showingModal, onClose: () => setShowingModeal(false) },
            React.createElement("div", { style: { width: '600px', marginLeft: 'auto', marginRight: 'auto', flex: 1, flexDirection: 'column', justifyContent: 'flex-start', padding: '20px', alignItems: 'space-between', display: 'flex' } },
                React.createElement("div", { style: { padding: '10px' } },
                    React.createElement(components_1.Input, { value: subject, onChange: (txt) => setSubject(txt), placeholder: 'Give us a summary' })),
                React.createElement("div", { style: { padding: '10px' } },
                    React.createElement("textarea", { rows: 5, className: 'sr', value: description, onChange: (e) => setDescription(e.target.value), placeholder: 'Tell us about your problem in depth' })),
    ...
    return (React.createElement(components_1.WidgetWrapper, { className: 'simple-request-button' },
        React.createElement("div", { style: { cursor: 'pointer', 'flex': 1, display: 'flex', justifyContent: 'center', alignItems: 'center' }, onClick: () => setShowingModeal(true) },
